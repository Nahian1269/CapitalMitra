    ...
    <DashboardLayout userType="investor">
      <div className="flex flex-col gap-8">
        <div>
          ...
          <p className="text-muted-foreground">Browse and discover promising startups seeking investment.</p>
           <div className="mt-4">
          ...
          {clients.map((client) => (
            <Card key={client.fullName} className="flex flex-col">
              ...
              <div className="p-6 pt-0">
                <a href={`mailto:user@example.com?subject=Investment Inquiry for ${client.company}&body=Dear ${client.fullName},`}>
